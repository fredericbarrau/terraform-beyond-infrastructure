...
- Pour ajouter des notes formateurs, ajouter un paragraphe commençant par `'Notes :'`.
...
- page de tp avec label : *"page-tp"* + attribut "data-label"
- page de démo : *"page-demo"* (label "Démo" par défaut)
- page de démo avec label : *"page-demo"* + attribut "data-label"
...
<!-- .slide: class="page-tp" data-label="Label via l'attribut 'data-label'"-->
...
<!-- .slide: class="page-demo" data-label="Label via l'attribut 'data-label'" -->
